...
import com.urise.webapp.ResumeTestData1;

import org.junit.Assert;
import org.junit.Before;
import org.junit.Test;

public abstract class AbstractStorageTest1 {
    protected final Storage storage;

    public AbstractStorageTest1(Storage storage) {
    ...
    static {
        RESUME_1 = ResumeTestData1.createResume(UUID1, name1);
        RESUME_2 = ResumeTestData1.createResume(UUID2, name2);
        RESUME_3 = ResumeTestData1.createResume(UUID3, name3);
        RESUME_4 = ResumeTestData1.createResume(UUID4, name1);
        RESUME_5 = ResumeTestData1.createResume(UUID1, name1);
    }
